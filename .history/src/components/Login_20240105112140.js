  ...
  return (
    <div>
      ...
      <form className="w-3/12 absolute p-12 bg-black my-36 mx-auto right-0 left-0 text-white opacity-80">
        ...
        <input type="email" placeholder="email" className="p-2 my-2 w-full bg-gray-700"/>
        <input type="password" placeholder="password" className="p-2 my-2 w-full  bg-gray-700"/>
        <button className="p-4 my-4 w-full bg-red-800" onClick={handleClick}>Sign In</button>
